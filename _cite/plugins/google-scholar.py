...
def main(entry):
    ...
    def query(_id):
        ...
        params_["author_id"] = _id
        dict_1 = GoogleSearch(params).get_dict()
        dict_2 = GoogleSearch(params_).get_dict()
        return get_safe(dict_1, "articles", []) + get_safe(dict_2, "articles", [])
